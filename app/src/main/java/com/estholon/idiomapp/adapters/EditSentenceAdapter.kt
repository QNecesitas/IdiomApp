...
class EditSentenceAdapter(private val context: Context , private var idioms: MutableList<Idioms>) :
    ListAdapter<Records , EditSentenceViewHolder>(DiffCallback) {

    fun setIdiomList(newIdioms: MutableList<Idioms>){
        idioms = newIdioms
    }
    ...
    class EditSentenceViewHolder(private var binding: RecyclerSentenceBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup , viewType: Int): EditSentenceViewHolder {
        val viewHolder = EditSentenceViewHolder(
    ...
    override fun onBindViewHolder(holder: EditSentenceViewHolder , position: Int) {
        holder.bind(
            getItem(position) ,
            context,
            idioms,
